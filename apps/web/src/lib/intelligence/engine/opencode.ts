 ...
 */
export async function listModels(forceRefresh = false, _authSessionId?: string): Promise<AvailableModel[]> {
  // Models are cached in data/models-cache.json (generated by `opencode models` natively).
  // No Docker container needed — native CLI has all providers/auth configured.
